...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 390.452475247524944, 532.0, 43.0, 22.0 ],
					"text" : "cycle~"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 677.0, 239.0, 45.0, 22.0 ],
					"text" : "curve~"
				}
...
, 			{
				"box" : 				{
					"color" : [ 1.0, 0.298039215686275, 0.952941176470588, 1.0 ],
					"id" : "obj-47",
					"maxclass" : "newobj",
					"numinlets" : 4,
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 677.0, 189.0, 131.0, 22.0 ],
...
, 			{
				"box" : 				{
					"color" : [ 0.996078431372549, 0.223529411764706, 1.0, 1.0 ],
					"id" : "obj-41",
					"maxclass" : "newobj",
					"numinlets" : 1,
					"numoutlets" : 2,
					"outlettype" : [ "float", "float" ],
					"patching_rect" : [ 317.0, 186.0, 29.5, 22.0 ],
					"text" : "t f f"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 192.0, 576.0, 206.5, 22.0 ],
					"text" : "*~ 1."
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 665.0, 542.0, 58.0, 22.0 ],
					"text" : "r mute.all"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 495.0, 423.0, 156.0, 48.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 705.0, 445.0, 175.0, 34.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 644.0, 451.0, 59.0, 22.0 ],
					"text" : "mute 0, 1"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 644.0, 576.0, 56.0, 22.0 ],
					"text" : "thispoly~"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 390.452475247524944, 673.0, 196.0, 48.0 ],
					"text" : "<= these 2 out objects will be used to monitor voice allocation outside the poly~",
					"textcolor" : [ 0.011765, 0.396078, 0.752941, 1.0 ],
					"textjustification" : 2
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 234.0, 13.0, 217.0, 20.0 ],
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 192.0, 252.0, 467.0, 22.0 ],
					"text" : "t f b b"
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 686.5, 408.0, 480.0, 408.0, 480.0, 423.0, 420.0, 423.0, 420.0, 519.0, 399.952475247524944, 519.0 ],
					"source" : [ "obj-49", 0 ]
				}
